 ...
 *
 ****************************************************************************/
void osCreateQueue(tQueueX* pQueue,
                   void**  pQueueArea,
                   tU16    size);
 ...
 *
 ****************************************************************************/
void* osPendQueue(tQueueX* pQueue,
                  tU16    timeout,
                  tU8*    pError);
 ...
 *
 ****************************************************************************/
void* osAcceptQueue(tQueueX* pQueue,
                    tU8*    pError);
 ...
 *
 ****************************************************************************/
void osFlushQueue(tQueueX* pQueue,
                  tU8*    pError);
 ...
 *
 ****************************************************************************/
void osPostQueue(tQueueX* pQueue,
                 void*   msg,
                 tU8*    pError);
 ...
 *
 ****************************************************************************/
void osPostFrontQueue(tQueueX* pQueue,
                      void*   msg,
                      tU8*    pError);
