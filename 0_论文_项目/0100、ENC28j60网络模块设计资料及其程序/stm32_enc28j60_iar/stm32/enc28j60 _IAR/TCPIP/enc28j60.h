...
//字节0 字节1 和后面的字节
//操作码参数数据
//读控制寄存器（RCR） 0 0 0 a a a a a N/A
//读缓冲器（RBM） 0 0 1 1 1 0 1 0 N/A
//写控制寄存器（WCR） 0 1 0 a a a a a d d d d d d d d
//写缓冲器（WBM） 0 1 1 1 1 0 1 0 d d d d d d d d
//位域置1 （BFS） 1 0 0 a a a a a d d d d d d d d
//位域清零（BFC） 1 0 1 a a a a a d d d d d d d d
...
#define ENC28J60_SOFT_RESET          0xFF//系统指令（软件复位）
