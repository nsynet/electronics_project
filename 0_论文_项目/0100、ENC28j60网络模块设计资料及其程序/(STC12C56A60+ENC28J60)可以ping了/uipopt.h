...
#define UIP_IPADDR0     192		/**< The first octet of the IP address of this uIP node, 
									if UIP_FIXEDADDR is */
#define UIP_IPADDR1     168		/**< The second octet of the IP address of
									this uIP node, if UIP_FIXEDADDR is*/
#define UIP_IPADDR2     110		/**< The third octet of the IP address of
									this uIP node, if UIP_FIXEDADDR is*/
...
#define UIP_DRIPADDR2   110		/**< The third octet of the IP address of the default router*/
