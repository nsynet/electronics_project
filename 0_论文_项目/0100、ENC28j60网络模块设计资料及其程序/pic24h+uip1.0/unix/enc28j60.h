...
// set CS to 0 = active
#define CSACTIVE  _LATB5=0
// set CS to 1 = passive
#define CSPASSIVE _LATB5=1
...
#define ENC28J60_RESET()    _LATB6=0
//
#define ENC28J60_UNRESET()  _LATB6=1
...
#include "uipopt.h"
#define MAX_FRAMELEN	(UIP_BUFSIZE)       // maximum ethernet frame length

#define ENC28J60_RX_ISR						// 是不是采用接收中断方式
...
extern void enc28j60_init( BYTE *pic_mac);
