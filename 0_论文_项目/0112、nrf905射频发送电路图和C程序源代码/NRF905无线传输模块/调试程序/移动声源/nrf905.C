...
while(1)
{
	 //=====================从键盘获得数据
	  ...
	  switch(P0)
	    {
	      case KEY1:P0=LED1;TxBuf[0]=0X0a;tf=1;break;	//10
	  	  case KEY2:P0=LED2;TxBuf[0]=0x14;tf=1;break;	//20
		  case KEY3:P0=LED3;TxBuf[0]=0x1e;tf=1;break;	//30
		  case KEY4:P0=LED4;TxBuf[0]=0x28;tf=1;break;	//40
	 ...
	 if (rsbrf!=0)
	  {
		 switch(rsbrf)
		   {
		     case 'A':P0=0X55;TxBuf[0]=0X55;delayf=1;break;
			 case 'B':P0=0XAA;TxBuf[0]=0xaa;delayf=1;break;
			 case 'C':P0=0X0F;TxBuf[0]=0xff;delayf=1;break;
			 case 'D':P0=0XF0;TxBuf[0]=0xf0;delayf=1;break;
		 	 //default:P0=0xff;TxBuf[0]=0xff; 
			}
	  //====================NRF905发送串口接收到的相应的字符 
	   if(TxBuf[0]!=0xff)
...
void RxPacket(void)
{
	...
	switch(P0)
	    {
	      case 0X55:TxData('A');;break;
	  	  case 0xaa:TxData('B');;break;
		  case 0x0f:TxData('C');;break;
		  case 0xf0:TxData('D');;break;
	 	  //default:P0=0xff;TxBuf[0]=0xff; 
		 } 
	 //=====================
