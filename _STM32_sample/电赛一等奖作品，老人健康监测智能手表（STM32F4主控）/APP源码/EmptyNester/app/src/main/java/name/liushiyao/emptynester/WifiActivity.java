...
/**
 * 该smartLink移植esp8266官方给出的源码，没有对核心代码进行任何操作，只是更改了布局
 */


public class WifiActivity extends Activity implements OnSmartLinkListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mPasswordEditText = (EditText) findViewById(R.id.smartlinker_password);
		...
		mStartButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(!mIsConncting){
					...
					//璁剧疆瑕侀厤缃殑ssid 鍜宲swd
					try {
						mSnifferSmartLinker.setOnSmartLinkListener(WifiActivity.this);
						//寮� smartLink
