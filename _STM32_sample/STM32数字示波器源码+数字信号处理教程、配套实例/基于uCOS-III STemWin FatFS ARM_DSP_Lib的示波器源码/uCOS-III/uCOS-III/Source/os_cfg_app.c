...
CPU_INT32U     const  OSCfg_IdleTaskStkSizeRAM   = (CPU_INT32U  )sizeof(CPU_STK_SIZE)*OS_CFG_IDLE_TASK_STK_SIZE;
...
CPU_INT32U     const  OSCfg_IntQTaskStkSizeRAM   = (CPU_INT32U  )sizeof(CPU_STK_SIZE)*OS_CFG_INT_Q_TASK_STK_SIZE;
#else
...
CPU_INT32U     const  OSCfg_ISRStkSizeRAM        = (CPU_INT32U  )sizeof(CPU_STK_SIZE)*OS_CFG_ISR_STK_SIZE;
#else
/********修改3*******/
CPU_STK      *   OSCfg_ISRStkBasePtr;
...
CPU_INT32U     const  OSCfg_StatTaskStkSizeRAM   = (CPU_INT32U  )sizeof(CPU_STK_SIZE)*OS_CFG_STAT_TASK_STK_SIZE;
#else
...
CPU_INT32U     const  OSCfg_TickTaskStkSizeRAM   = (CPU_INT32U  )sizeof(CPU_STK_SIZE)*OS_CFG_TICK_TASK_STK_SIZE;
...
CPU_INT32U     const  OSCfg_TmrTaskStkSizeRAM    = (CPU_INT32U  )sizeof(CPU_STK_SIZE)*OS_CFG_TMR_TASK_STK_SIZE;
...
CPU_INT32U     const  OSCfg_DataSizeRAM          = sizeof(CPU_STK_SIZE)*OS_CFG_IDLE_TASK_STK_SIZE

#if (OS_CFG_ISR_POST_DEFERRED_EN > 0u)
                                                 + sizeof(OSCfg_IntQ)
                                                 + sizeof(CPU_STK_SIZE)*OS_CFG_INT_Q_TASK_STK_SIZE
#endif
...
#if (OS_CFG_STAT_TASK_EN > 0u)
                                                 + sizeof(CPU_STK_SIZE)*OS_CFG_STAT_TASK_STK_SIZE
#endif

#if (OS_CFG_TMR_EN > 0u)
                                                 + sizeof(CPU_STK_SIZE)*OS_CFG_TMR_TASK_STK_SIZE
                                                 + sizeof(OSCfg_TmrWheel)
#endif

#if (OS_CFG_ISR_STK_SIZE > 0u)
                                                 + sizeof(CPU_STK_SIZE)*OS_CFG_ISR_STK_SIZE
#endif
                                                 + sizeof(CPU_STK_SIZE)*OS_CFG_TICK_TASK_STK_SIZE
