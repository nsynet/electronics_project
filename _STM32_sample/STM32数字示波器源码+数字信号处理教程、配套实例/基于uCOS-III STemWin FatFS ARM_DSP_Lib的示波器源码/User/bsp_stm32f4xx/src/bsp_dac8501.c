...
#define DAC8501_RCC_CS1 	RCC_AHB1Periph_GPIOF
#define DAC8501_PORT_CS1	GPIOF
#define DAC8501_PIN_CS1		GPIO_Pin_7
...
static void DAC8501_ConfigGPIO(void)
{
	...
	/* 打开GPIO时钟 */
	RCC_AHB1PeriphClockCmd(DAC8501_RCC_CS1 | DAC8501_RCC_CS2, ENABLE);
