...
*	形    参: _gain : 增益  ADS1256_GAIN_E
*			  _drate : 数据输出速率  ADS1256_DRATE_E
*			 _mode : 1 表示差分模式， 0表示单端模式
*	返 回 值: 无
*********************************************************************************************************
*/
void ADS1256_CfgADC(ADS1256_GAIN_E _gain, ADS1256_DRATE_E _drate, uint8_t _mode)
{	
	g_tADS1256.Gain = _gain;
	g_tADS1256.DataRate = _drate;
	g_tADS1256.DiffMode = _mode;
