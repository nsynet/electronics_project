...
/* TM7705 */
#define TM7705_RCC_CS 		RCC_AHB1Periph_GPIOF
#define TM7705_PORT_CS		GPIOF
#define TM7705_PIN_CS		GPIO_Pin_7

#define TM7705_CS_1()		TM7705_PORT_CS->BSRRL = TM7705_PIN_CS
#define TM7705_CS_0()		TM7705_PORT_CS->BSRRH = TM7705_PIN_CS
