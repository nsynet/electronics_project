...
void Init_Palette(void)
{
    ...
    LCD_Line(0,120,320,120);
    LCD_Line(0,160,320,160);
	LCD_Line(0,200,320,200);
	LCD_Line(0,240,320,240);
	LCD_Line(0,120,0,240);
	LCD_Line(54,120,54,240);
	LCD_Line(108,120,108,240);
	LCD_Line(162,120,162,240);
	LCD_Line(216,120,216,240);
	LCD_Line(270,120,270,240);
	LCD_Line(320,120,320,240);
	
	LCD_Str_CH(125,50,"基于",0,0xffff);
		LCD_Str_O(157, 50,"STM32",0);
	LCD_Str_CH(197,50,"处理器的",0,0xffff);
	LCD_Str_CH(80,70,"武警报警信息系统终端",0,0xffff);	

//	LCD_Str_6x12_O(100, 70,"baojingxitong", 0);
//	LCD_Str_O(80, 70,"baojingxitong",0);
