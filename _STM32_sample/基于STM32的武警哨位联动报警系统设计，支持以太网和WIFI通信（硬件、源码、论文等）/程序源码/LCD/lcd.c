...
{
	LCD_Rectangle(275,0,45,240,0x8410);//上面颜色
	LCD_Rectangle(0,0,110,240,0x8410);//键盘背景
	
	LCD_Line(2,2,2,238);
	LCD_Line(318,2,318,238);
	LCD_Line(2,2,318,2);
	LCD_Line(2,238,318,238); //显示屏区域
	
	
	
//	LCD_Line(110,5,275,5);
	LCD_Line(275,2,275,238);
	LCD_Line(110,2,110,238);
//	LCD_Line(110,235,275,235);
	LCD_Str_ENCH_O_P(190,60,"3号哨位报告灾害",RED);
//	LCD_Str_ENCH_O_P(180,65,"信息系统终端",BLACK);
	LCD_Str_ENCH_O_P(288,60,"武警报警系终端3哨位",BLACK);
	
    
	/*显示图像*/
    Lcd_show_bmp(10, 4,"/1.bmp");  
    Lcd_show_bmp(10, 63,"/2.bmp"); 
	  Lcd_show_bmp(10, 122,"/3.bmp");
		Lcd_show_bmp(10, 181,"/4.bmp");
		
    Lcd_show_bmp(42, 4,"/5.bmp");  
    Lcd_show_bmp(42, 63,"/6.bmp"); 
	  Lcd_show_bmp(42, 122,"/7.bmp");
		Lcd_show_bmp(42, 181,"/8.bmp");
		
		Lcd_show_bmp(73, 4,"/10.bmp");
		Lcd_show_bmp(73, 63,"/11.bmp");
		Lcd_show_bmp(73, 122,"/12.bmp");
		Lcd_show_bmp(73, 181,"/13.bmp");
		
	Lcd_show_bmp(280,5,"/9.bmp");
}
        ...
        if(*str<125)
				{
					...
					LCD_Char_O(Tmp_x,Tmp_y, *str,Color);
					str++ ;
					Tmp_x	+= 8;
				}
				else
				{
					if(*str==163)									/*163-172 是中文逗号	 163-187是中文分号*/
					{
						LCD_Char_O(Tmp_x,Tmp_y, ' ',Color);		/*改为显示1个空格*/
						str += 2 ;
						Tmp_y	+= 8 ;
					...
					LCD_Char_CH_O(Tmp_x,Tmp_y,str,Color);
          str += 2 ;
        	Tmp_x += 16 ;						
        }
    }
