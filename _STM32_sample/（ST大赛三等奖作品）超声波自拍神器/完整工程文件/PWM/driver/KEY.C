...
void Key_Init(void)
{
      ...
      SYSCFG_EXTILineConfig(KEY_BUTTON_EXTI_PORT_SOURCE, KEY1_BUTTON_EXTI_PIN_SOURCE);
      SYSCFG_EXTILineConfig(KEY_BUTTON_EXTI_PORT_SOURCE, KEY2_BUTTON_EXTI_PIN_SOURCE);
     
      EXTI_InitStructure.EXTI_Line = KEY1_BUTTON_EXTI_LINE;  //PC13
