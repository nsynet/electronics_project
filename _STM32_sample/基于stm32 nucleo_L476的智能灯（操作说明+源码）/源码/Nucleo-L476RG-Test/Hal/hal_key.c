...
* 定时器TIM6的中断函数内完成多按键检测逻辑,这个放到product.c文件实现
* @param none
* @return none
*/
...
//{
//	if(htim->Instance ==TIM6)//tim6 1ms中断，按键检测逻辑
//	{
...
//    for(temI = 0; temI < keys->keyTotolNum; temI++) //初始化按键绑定的GPIO参数
//    {
