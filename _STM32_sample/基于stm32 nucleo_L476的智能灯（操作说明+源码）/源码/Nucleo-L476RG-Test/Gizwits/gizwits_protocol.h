...
* @{
*/
#define PRODUCT_KEY "8d9ada8885474f1bb81898181f6692e4"
/**@} */

/**@name 数据点相关定义
* @{
*/
#define LD2_ONOFF_BYTEOFFSET                    0
#define LD2_ONOFF_BITOFFSET                     0
#define LD2_ONOFF_LEN                           1

#define FAULT_LED_BYTEOFFSET                    2
#define FAULT_LED_BITOFFSET                     0
#define FAULT_LED_LEN                           1

#define FAULT_TEM_BYTEOFFSET                    2
#define FAULT_TEM_BITOFFSET                     1
#define FAULT_TEM_LEN                           1


#define CHIPTEMP_RATIO                         1
#define CHIPTEMP_ADDITION                      0
#define CHIPTEMP_MIN                           0
#define CHIPTEMP_MAX                           100
...
__packed typedef struct {
  ...
  uint8_t valueChipTemp;


  uint8_t valueFault_LED:1;
  uint8_t valueFault_Tem:1;
  
  uint8_t valuereserve_1:6;
} devStatus_t;                                      
