package com.example.smartcontrol_view;
...
public class AddAndSubView extends LinearLayout
{
	...
	EditText editText;
	int num;          //editText中的数�??
	int editTextLayoutWidth;  //editText视图的宽�?
	int editTextLayoutHeight;  //editText视图的宽�?
	int editTextMinimumWidth;  //editText视图的最小宽�?
	int editTextMinimumHeight;  //editText视图的最小高�?
	int editTextMinHeight;  //editText文本区域的最小高�?
	int editTextHeight;  //editText文本区域的高�?
	...
	private void control()
	{
		...
		setViewsLayoutParm();  //设置内部view的布�?参数
		insertView();            //将子view放入linearlayout�?
		setViewListener();
	}
	...
	private void setViewsLayoutParm()
	{
		...
		leftLinearLayout.setLayoutParams(viewLayoutParams);  //参数：宽、高、比重，比重�?1.0
		rightLinearLayout.setLayoutParams(viewLayoutParams);  //参数：宽、高、比重，比重�?1.0
	...
	private void setTextWidthHeight()
	{
		...
		{
			// 将数据从dip(即dp)转换到px，第�?参数为数据原单位（此为DIP），第二参数为要转换的数据�??
	...
	private void insertView()
	{
		...
		addView(mainLinearLayout);  //将整块视图添加进当前AddAndSubView�?
	}
	...
	/**
	 * 设置EditText视图的最小高�?
	 * @param editTextMinimumHeight EditText视图的最小高�?,单位：px
	 */
	...
	/**
	 * 设置EditText文本区域的最小高�?
	 * @param editTextMinHeight EditText文本区域的最小高�?,单位：px
	 */
	...
	/**
	 * 设置EditText文本区域的高�?
	 * @param editTextHeight EditText文本区域的高�?,单位：px
	 */
	...
	/**
	 * 设置EditText视图的宽�?
	 * @param editTextLayoutWidth 设置EditText视图的宽�?,单位px
	 */
	...
	/**
	 * 以Drawable形式 设置按钮背景�?
	 * @param addBtnDrawable 加号背景�?
	 * @param subBtnDrawable 减号背景�?
	 */
	...
	/**
	 * 以资源Resource形式 设置按钮背景�?
	 * @param addBtnResource 加号背景�?
	 * @param subBtnResource 减号背景�?
	 */
	...
	/**
	 * 设置按钮背景�?
	 * @param addBtnColor 加号背景�?
	 * @param subBtnColor 减号背景�?
	 */
		...
		public void onClick(View v)
		{
			...
			} else
			{
				if (v.getTag().equals("+"))
				{
					...
					{
						num--;
						Toast.makeText(context, "请输入一个大于0的数",
