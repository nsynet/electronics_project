...
u16 Get_Adc(u32 ch)   
{
    ...
    ADC1_ChanConf.SamplingTime=ADC_SAMPLETIME_640CYCLES_5;        //采样时间
...
//采集MQ2的AD，当AD<0.3V时判断空气质量为级别‘A’，在0.3V-1.0V之间判断级别为‘B’，1.0V以上判断为'C'
...
//采集MQ135的AD，当AD<0.3V时判断空气质量为级别‘A’，在0.3V-1.0V之间判断级别为‘B’，1.0V以上判断为'C'
