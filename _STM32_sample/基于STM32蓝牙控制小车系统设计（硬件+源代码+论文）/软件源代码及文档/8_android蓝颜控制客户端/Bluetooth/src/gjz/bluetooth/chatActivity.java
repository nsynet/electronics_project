...
public class chatActivity extends Activity implements OnItemClickListener ,OnClickListener{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.chat_tt);  // jesse  修改对应布局
        mContext = this;
        init();
    }
	...
	private void init() {		   
		...
		sendButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				String msgText ="1"; // change sendstring jesse
				if (msgText.length()>0) {
					sendMessageHandle(msgText);	
					editMsgView.setText("");
					editMsgView.clearFocus();
		 ...
		 * right  jesse
		 */
		sendButton= (Button)findViewById(R.id.right);
		sendButton.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
		 ...
		 * down  by jesse
		 */
		sendButton= (Button)findViewById(R.id.stop);
		sendButton.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
