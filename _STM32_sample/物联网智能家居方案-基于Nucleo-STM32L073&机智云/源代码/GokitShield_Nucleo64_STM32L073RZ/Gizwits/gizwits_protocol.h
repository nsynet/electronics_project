...
#define SEND_MAX_TIME       6000                   ///< 6000ms重发
#define SEND_MAX_NUM        5                       ///< 重发次数
...
* @{
*/
#define PRODUCT_KEY "45f4bb6084594002b6364e5248fe080f"
/**@} */
...
__packed typedef struct {
  ...
  uint8_t valueAlert_1:1;
  uint8_t valueAlert_2:1;
  
  uint8_t valuereserve_2:6;

  uint8_t valueFault_LED:1;
  uint8_t valueFault_Motor:1;
  uint8_t valueFault_TemHum:1;
  uint8_t valueFault_IR:1;
  
  uint8_t valuereserve_3:4;
} devStatus_t;                                      
